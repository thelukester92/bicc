...
private:
	void removeBridges(const Graph &g, const Graph &t, const Graph &nt, std::vector<size_t> &parent, std::vector<size_t> &level, std::vector< std::vector<size_t> > &components);
